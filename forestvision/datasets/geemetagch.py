...
class GEEMetaHRGCH(GEERasterDataset):
    """Meta and WRI High Resolution Global Canopy Height on Google Earth Engine."""

    filename_glob = "*.tif"

    gee_asset_id = "projects/meta-forest-monitoring-okw37/assets/CanopyHeight"

    all_bands = ["cover_code"]

    nodata = 0

    is_image = False

    instrument = "HR Global Canopy Height "
    ...
    def __init__(
        ...
        Args:
            ...
            res : float
                Resolution of the dataset. Default is 1.
            crs : Optional[CRS]
