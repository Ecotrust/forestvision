...
class UNet(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=True, dropout=0.5):
        super(UNet, self).__init__()
        factor = 2 if bilinear else 1

        # Encoder
        self.inc = ConvBlock(in_channels, 64, dropout=0)
        self.down1 = EncoderBlock(64, 128, dropout=dropout / 4)
        self.down2 = EncoderBlock(128, 256, dropout=dropout / 3)
        self.down3 = EncoderBlock(256, 512, dropout=dropout / 2)
        # Bottleneck
